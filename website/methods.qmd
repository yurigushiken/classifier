...
The full prompt source code is available in the [GitHub repository](https://github.com/yurigushiken/classifier/blob/main/src/classifier_pipeline/prompts.py).
